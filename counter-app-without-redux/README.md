...
```
ng new counter-app-without-redux --no-strict --standalone=false --style=scss --ssr=no --skip-tests --package-manager="npm"
```
...
5. Crear el componente granddaughter `ng g c granddaughter`
